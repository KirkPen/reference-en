...
`timeout` (optional): the number of microseconds to wait for the complete pulse to be received within the timeout, or gives up and returns 0.; default is one second (unsigned long)
[float]
=== Returns
